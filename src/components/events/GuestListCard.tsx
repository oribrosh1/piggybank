    ...
    >
      <View style={{ flexDirection: "row", alignItems: "center", justifyContent: "space-between", marginBottom: 16 }}>
        <View style={{ flexDirection: "row", alignItems: "center" }}>
          ...
          >
            <Text style={{ fontSize: 13, fontWeight: "800", color: "#8B5CF6" }}>{event.totalGuests}</Text>
          </View>
        </View>
        <TouchableOpacity
          onPress={onAddGuest}
                ...
                return (
                  ...
                  >
                    ...
                    <View style={{ flex: 1, marginLeft: 12 }}>
                      <Text style={{ fontSize: 15, fontWeight: "700", color: "#111827" }}>{guest.name}</Text>
                      <Text style={{ fontSize: 13, color: "#9CA3AF", marginTop: 2 }}>{guest.phone}</Text>
                    </View>
                    <View
                      style={{
