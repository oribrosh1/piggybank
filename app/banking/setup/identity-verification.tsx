...
import { DocumentUpload } from "../../../types/verifications";
...
export default function IdentityVerificationScreen() {
  ...
  useEffect(() => {
    // Animate progress bar to 100% (step 2 of 2)
  ...
  const showUploadOptions = () => {
    Alert.alert(
      ...
      "How would you like to upload your ID?",
      [
        {
          text: "Take Photo",
  ...
  const validateAndSubmit = () => {
    ...
    // TODO: Upload document to Firebase Storage and create Stripe account
