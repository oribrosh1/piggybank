...
import {
  deleteLegacyAttireFootwearFields,
  getEvent,
  updateEvent,
} from "@/src/lib/eventService";
import {
  buildEventTitleFromChild,
  honoreeNameFromEvent,
} from "@/src/lib/eventTitle";
...
export default function EditEventScreen() {
  ...
  const loadEvent = async () => {
    ...
    if (eventData) {
      ...
      setFormData({
        ...
        partyVibe: eventData.partyVibe || "",
        honoreeFavoriteColor: eventData.honoreeFavoriteColor || "",
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      const addedOptionalDetails = !!(
        ...
        formData.honoreeFavoriteColor?.trim() ||
        formData.partyType ||
        formData.kosherType ||
        formData.mealType ||
        formData.eventCategory
      );
      const dressCodeTrim = formData.dressCode?.trim();
      const result = await updateEvent(id, {
        ...
        ...(dressCodeTrim
          ? { dressCode: dressCodeTrim }
          : { dressCode: firestore.FieldValue.delete() }),
        theme: formData.theme,
        ...(formData.partyVibe?.trim()
          ? { partyVibe: formData.partyVibe.trim() }
          : { partyVibe: firestore.FieldValue.delete() }),
        ...(formData.honoreeFavoriteColor?.trim()
          ? { honoreeFavoriteColor: formData.honoreeFavoriteColor.trim() }
          : { honoreeFavoriteColor: firestore.FieldValue.delete() }),
        ...deleteLegacyAttireFootwearFields(),
        ...(formData.parking?.trim()
          ? { parking: formData.parking.trim() }
          : { parking: firestore.FieldValue.delete() }),
        ...(formData.locationNotes?.trim()
          ? { locationNotes: formData.locationNotes.trim() }
          : { locationNotes: firestore.FieldValue.delete() }),
        ...(formData.kosherType?.trim()
          ? { kosherType: formData.kosherType.trim() }
          : { kosherType: firestore.FieldValue.delete() }),
        ...(formData.mealType?.trim()
          ? { mealType: formData.mealType.trim() }
          : { mealType: firestore.FieldValue.delete() }),
        ...(formData.vegetarianType?.trim()
          ? { vegetarianType: formData.vegetarianType.trim() }
          : { vegetarianType: firestore.FieldValue.delete() }),
        ...(formData.mealType?.trim() === "dairy"
          ? {}
          : { chalavYisrael: firestore.FieldValue.delete() }),
        age: formData.age,
        date: formData.date,
        time: formData.time,
        address1: formData.address1,
        address2: formData.address2,
        optionalDetailsLater: addedOptionalDetails
          ? false
          : (event.optionalDetailsLater ?? false),
  ...
  const handleTimeConfirm = (time: Date) => {
    ...
    handleInputChange(
      "time",
      `${String(hour12).padStart(2, "0")}:${String(minutes).padStart(2, "0")} ${period}`,
    );
      ...
      <View style={{ flex: 1, backgroundColor: "transparent" }}>
            ...
            <View style={{ marginBottom: 24 }}>
              ...
              <View
                style={{
                  ...
                  padding: 20,
                  borderWidth: 2,
                  borderColor: focusedField === "age" ? "#8B5CF6" : "#E5E7EB",
                }}
              >
                <TextInput
                  style={{
            ...
            <View style={{ marginBottom: 24 }}>
              ...
              <View
                style={{
                  ...
                  backgroundColor: "#F9FAFB",
                  borderColor:
                    focusedField === "childName" ? "#8B5CF6" : "#E5E7EB",
                }}
              >
                <TextInput
                  style={{
            ...
            >
              ...
              {isBarBatMitzvah && (
                <View style={{ marginBottom: 18 }}>
                  ...
                  <View style={{ flexDirection: "row", gap: 10 }}>
                    {[
                      { value: "formal", label: "🕎", name: "The Ceremony" },
                      { value: "party", label: "🎉", name: "The Party" },
                    ].map((opt) => (
                      <TouchableOpacity
                        key={opt.value}
                        onPress={() =>
                          handleInputChange("eventCategory", opt.value)
                        }
                        style={{
                          flex: 1,
                          backgroundColor:
                            formData.eventCategory === opt.value
                              ? "#8B5CF6"
                              : "#F9FAFB",
                          borderRadius: 14,
                          paddingVertical: 14,
              ...
              {isBarBatMitzvah && formData.eventCategory === "formal" && (
                <View style={{ marginBottom: 18 }}>
                  ...
                  <TextInput
                    style={{
                      backgroundColor:
                        focusedField === "dressCode" ? "#F5F3FF" : "#F9FAFB",
                      borderRadius: 14,
                      ...
                      borderWidth: 2,
                      borderColor:
                        focusedField === "dressCode" ? "#8B5CF6" : "#E5E7EB",
                    }}
                    placeholder="e.g. Black tie, Cocktail…"
                    placeholderTextColor="#D1D5DB"
                    value={formData.dressCode}
                    onChangeText={(v) => handleInputChange("dressCode", v)}
                    ...
                    >
                      {PARTY_TYPE_OPTIONS.map((opt) => (
                        <TouchableOpacity
                          key={opt.value}
                          onPress={() =>
                            handleInputChange("partyType", opt.value)
                          }
                          style={{
                            width: "30%",
                            backgroundColor:
                              formData.partyType === opt.value
                                ? "#8B5CF6"
                                : "#F9FAFB",
                            borderRadius: 14,
                            paddingVertical: 12,
              ...
              <View style={{ marginBottom: 16 }}>
                ...
                <TextInput
                  style={{
                    backgroundColor:
                      focusedField === "theme" ? "#F5F3FF" : "#F9FAFB",
                    borderRadius: 14,
                    paddingHorizontal: 16,
                    paddingVertical: 14,
                    fontSize: 16,
                    ...
                    borderWidth: 2,
                    borderColor:
                      focusedField === "theme" ? "#8B5CF6" : "#E5E7EB",
                  }}
              ...
              {isPartyMode ? (
                <View style={{ marginBottom: 16 }}>
                  ...
                  >
                    Mood, music, activities — helps the AI poster feel unique.
                  </Text>
                  <TextInput
                    style={{
                      minHeight: 88,
                      ...
                      backgroundColor:
                        focusedField === "partyVibe" ? "#F5F3FF" : "#F9FAFB",
                      borderRadius: 14,
                      paddingHorizontal: 16,
                      paddingVertical: 12,
                      fontSize: 16,
                      ...
                      borderWidth: 2,
                      borderColor:
                        focusedField === "partyVibe" ? "#8B5CF6" : "#E5E7EB",
                      lineHeight: 22,
                    }}
                    placeholder="e.g. Glow sticks and a DJ, pizza then games…"
                    placeholderTextColor="#D1D5DB"
                    value={formData.partyVibe ?? ""}
                    onChangeText={(v) => handleInputChange("partyVibe", v)}
            ...
            >
              ...
              <View style={{ marginBottom: 16 }}>
                ...
                <GooglePlacesTextInput
                  scrollEnabled={false}
                  placeHolderText={
                    formData.address1 || "Enter event location..."
                  }
                  ...
                  style={{
                    input: {
                      borderWidth: 2,
                      borderColor:
                        focusedField === "address1" ? "#8B5CF6" : "#E5E7EB",
                      borderRadius: 12,
                      backgroundColor: "#F9FAFB",
                      padding: 12,
                    },
              ...
              <View>
                ...
                <TextInput
                  style={{
                    backgroundColor:
                      focusedField === "locationNotes" ? "#F5F3FF" : "#F9FAFB",
                    borderRadius: 12,
                    ...
                    borderWidth: 2,
                    borderColor:
                      focusedField === "locationNotes" ? "#8B5CF6" : "#E5E7EB",
                    minHeight: 76,
                    textAlignVertical: "top",
                  }}
                  placeholder="Gate code, entrance, elevator…"
                  placeholderTextColor="#D1D5DB"
                  value={formData.locationNotes ?? ""}
                  onChangeText={(v) => handleInputChange("locationNotes", v)}
                  onFocus={() => setFocusedField("locationNotes")}
                  onBlur={() => setFocusedField(null)}
                  multiline
                  maxLength={280}
                />
                ...
                <TextInput
                  style={{
                    backgroundColor:
                      focusedField === "parking" ? "#F5F3FF" : "#F9FAFB",
                    borderRadius: 12,
                    paddingHorizontal: 14,
                    paddingVertical: 12,
                    fontSize: 15,
                    ...
                    borderWidth: 2,
                    borderColor:
                      focusedField === "parking" ? "#8B5CF6" : "#E5E7EB",
                    minHeight: 76,
                    textAlignVertical: "top",
                  }}
        ...
        >
          <TouchableOpacity
            ...
            disabled={saving}
            style={{
              backgroundColor: saving ? "#D1D5DB" : "#8B5CF6",
              borderRadius: 20,
              paddingVertical: 20,
              alignItems: "center",
              flexDirection: "row",
      ...
      >
        ...
        >
          ...
          >
            ...
            <View style={{ marginTop: 20, gap: 12 }}>
              <TouchableOpacity
                onPress={() => handleTimeConfirm(selectedTime)}
                style={{
                  backgroundColor: "#8B5CF6",
                  borderRadius: 16,
                  paddingVertical: 16,
